...
BOOST_AUTO_TEST_CASE(test_HMM_MultiplyVec2_int_BothVecsZeros, TOLERANCE) {
    //Arrange
...
BOOST_AUTO_TEST_CASE(test_HMM_MultiplyVec2_int_V1_zeros, TOLERANCE) {
    //Arrange
    auto zeros = HMM_Vec2i(0, 0);
...
BOOST_AUTO_TEST_CASE(test_HMM_MultiplyVec2_int_postives, TOLERANCE) {
    //Arrange
...
BOOST_AUTO_TEST_CASE(test_HMM_MultiplyVec2_int_pos_neg, TOLERANCE) {
    //Arrange
    auto left = HMM_Vec2i(1, 5);
    auto right = HMM_Vec2i(-3, -4);
    //Act
...
BOOST_AUTO_TEST_CASE(test_HMM_MultiplyVec2_float_pos_neg, TOLERANCE) {
    //Arrange
...
BOOST_AUTO_TEST_CASE(test_HMM_MultiplyVec2f_vec_x_posfloat, TOLERANCE) {
    //Arrange
    auto left = HMM_Vec2(.5, .2);
    float right = 10.;
    //Act
...
BOOST_AUTO_TEST_CASE(test_mul_vec2_by_vec2_using_mul_operator, TOLERANCE) {
    //Arrange
...
BOOST_AUTO_TEST_CASE(test_mul_vec2_by_float_using_mul_operator, TOLERANCE) {
    //Arrange
    auto left = HMM_Vec2(.5, .2);
    float right = 10.;
    //Act
...
BOOST_AUTO_TEST_CASE(test_mul_vec2_by_vec2_using_mul_equal_operator, TOLERANCE) {
    //Arrange
    auto left = HMM_Vec2(.5, .2);
    auto right = HMM_Vec2(-2, -5.);
    //Act
...
BOOST_AUTO_TEST_CASE(test_mul_vec2_by_float_using_mul_equal_operator, TOLERANCE) {
    //Arrange
    auto left = HMM_Vec2(.5, .2);
    float right = 10.;
    //Act
...
BOOST_AUTO_TEST_CASE(test_HMM_MultiplyMat4, TOLERANCE) {
    //Arrange
    auto left = hmm_mat4();
...
BOOST_AUTO_TEST_CASE(test_HMM_MultiplyMat4f, TOLERANCE) {
    //Arrange
    auto left = hmm_mat4();
    float arr[4][4] = {{1, 2, 3, 4},
                       {5, -6, 7, 8},
...
BOOST_AUTO_TEST_CASE(test_HMM_MultiplyMat4ByVec4, TOLERANCE) {
    //Arrange
    auto left = hmm_mat4();
    float arr[4][4] = {{1, 2, 3, 4},
                       {5, -6, 7, 8},
...
BOOST_AUTO_TEST_CASE(test_mul_mat4_by_mat4_using_mul_operator, TOLERANCE) {
    //Arrange
    auto left = hmm_mat4();
    float arr[4][4] = {{1, 2, 3, 4},
                       {5, -6, 7, 8},
...
BOOST_AUTO_TEST_CASE(test_mul_mat4_by_floatscalar_using_mul_operator, TOLERANCE) {
    //Arrange
    auto left = hmm_mat4();
    float arr[4][4] = {{1, 2, 3, 4},
                       {5, -6, 7, 8},
...
BOOST_AUTO_TEST_CASE(test_mul_mat4_by_vec4_using_mul_operator, TOLERANCE) {
    //Arrange
    auto left = hmm_mat4();
    float arr[4][4] = {{1, 2, 3, 4},
                       {5, -6, 7, 8},
